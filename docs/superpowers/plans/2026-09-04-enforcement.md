...
printf '{ "repo": "robertblust/conventions", "tag": "v1.3.2", "exclude": ["meta"] }\n' > conventions.json
...
git commit -F - <<'EOF'
Conventions v1.3.2, a conventions job, and three spellings

The pin moves to v1.3.2, which brings conventions-check beside the sync script; meta/ is
